...
Public Class FormUsuarios
    ...
    Private Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        ...
        Using usua As New ProyectoTallerEntities5
    ...
    Private Sub BAgregar_Click(sender As Object, e As EventArgs) Handles BGuardar.Click
        ...
        Else
            ...
            If result = MsgBoxResult.Yes Then
                Dim usuario As New Usuario1(CBPerfil.SelectedValue, txtDNI.Text, txtNom.Text, txtApe.Text, txtUsua.Text, txtContr.Text, txtEmail.Text, txtTel.Text, 0, "no")
    ...
    Private Sub FormUsuarios_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        Mostrar()
        Try
            Using perfiles As New ProyectoTallerEntities5
